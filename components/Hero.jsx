        ...
        <div className="container xl:max-w-[1140px] 2xl:max-w-[1320px] mx-auto px-3 h-full flex-1 flex items-center">
          <div className="flex items-center justify-between h-full flex-wrap lg:flex-nowrap">
            <div className="xl:w-5/12 md:w-6/12 w-full">
              <h1 className="lg:text-8xl md:text-[45px] text-[35px] tracking-[-2%] text-white leading-[118%]">
                Elevate your
            ...
            <div className="xl:w-9/12 md:w-6/12 w-full flex md:flex-row flex-col justify-center md:justify-end relative after:contents-[''] after:h-[500px] after:w-[450px] after:absolute bgHeroImg after:opacity-30 after:rounded-full after:blur-[137px] after:pointer-events-none">
              <Image
                width={590}
                height={590}
