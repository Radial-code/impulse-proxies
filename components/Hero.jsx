        ...
        <div className=" hero-section grad_b flex flex-col justify-center lg:py-8 xl:py-0 pt-[30px] sm:pb-[80px] pb-14">
          <div className="container xl:max-w-[1220px] 2xl:max-w-[1320px] mx-auto xl:px-3 px-4 h-full flex items-center">
            <div className="flex items-center justify-between h-full flex-wrap w-full lg:flex-nowrap lg:pt-[70px] lg:pb-[90px]">
              <div className="md:w-[56%] xl:w-7/12 lg:w-6/12 w-full">
                ...
                <div className="md:flex hidden sm:mb-0 mb-5 items-center mt-12 ">
                  <button className="hover:bg-transparent transition-all lg:max-w-[201px] min-w-[216px] w-full md:min-h-[55px] min-h-[50px] leading-[120%] border-[2px] border-cyan-green bg-[#163D51] rounded-[100px] font-Montserrat font-semibold text-2xl text-white">
                    Purchase
                  </button>
                  <button className="lg:ms-5 ms-4 leading-[120%] hover:bg-[#163D51] transition-all lg:max-w-[226px] min-w-[216px] w-full md:min-h-[55px] min-h-[50px] border-[2px] border-white bg-[#050829] hover:border-cyan-green rounded-[100px] font-Montserrat font-semibold text-2xl text-white">
                    Explore Products
                  </button>
                </div>
              </div>
              <div className="md:w-[44%] w-11/12 xl:w-6/12 lg:w-6/12 mx-auto sm:mt-7 md:mt-0 flex lg:flex-row flex-col justify-center md:justify-end relative after:contents-[''] after:h-[500px] after:w-[450px] after:absolute bgHeroImg after:opacity-30 after:rounded-full after:blur-[137px] after:pointer-events-none after:top-[-50%]">
