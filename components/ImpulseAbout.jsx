  ...
  return (
    ...
    >
      ...
      <div className="container xl:max-w-[1220px] flex flex-col 2xl:max-w-[1320px] mx-auto xl:px-3 px-4 relative">
        ...
        <p className=" text-dark-gray leading-[157%] font-normal md:font-semibold lg:text-2xl text-[15px] text-center sm:pt-4 pt-4 tracking-[-0.74px] md:text-center lg:text-start lg:mx-0">
          Lorem ipsum dolor sit amet, consectetur adipiscing eiusmod
        </p>
        <div className="flex lg:flex-nowrap justify-center flex-wrap lg:gap-6 xl:pb-[138px] md:pb-[83px] pb-[52px] lg:mt-10 pt-lg-0 sm:pt-4 pt-[6px]">
          {AboutBox.map((about) => {
            return (
              <div
                key={about.id}
