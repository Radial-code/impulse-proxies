...
const OurProxies = () => {
  return (
    <div className="pt-[52px] lg:pt-[105px] pb-20 md:pb-[106px] lg:pb-[153px]  bg-[#040426] relative">
      <div className="our_proxies_box h-10 opacity-10 w-full max-w-[800px] mx-auto absolute top-[21px] left-[27%]"></div>
      ...
      <div className="container xl:max-w-[1220px] flex flex-col 2xl:max-w-[1320px] mx-auto xl:px-3 px-4">
        ...
        <div className="flex justify-center md:justify-start lg:justify-center flex-wrap  lg:flex-nowrap lg:gap-9   max-w-[1100px] md:mx-0 lg:mx-auto">
          <div className="flex  flex-wrap  lg:flex-nowrap lg:gap-9 mt-[53px] md:mt-8 lg:mt-10">
