  ...
  return (
    ...
    >
      ...
      <div className="container xl:max-w-[1220px] flex flex-col 2xl:max-w-[1320px] mx-auto xl:px-3 px-4 mt-5 lg:mt-0">
        <h2 className=" font-Montserrat  text-[20px]  md:text-[28px] lg:text-6xl text-white font-bold leading-[30px]  mb-4 ms-2 text-center lg:text-start">
        ...
        <div className="flex justify-center lg:justify-start flex-wrap relative z-20 lg:flex-nowrap lg:gap-9 2xl:gap-9  mt-[53px] md:mt-8 lg:mt-10  ">
        ...
        <div className=" flex justify-center  lg:justify-center relative">
          <button className="  w-full max-w-[193px] min-h-[54px] border-[2px] border-[#50EED7] bg-[#163D51] rounded-[100px] font-Montserrat font-semibold text-2xl text-white mt-10 hover:bg-transparent transition-all duration-300">
            Try Now
          </button>
        </div>
      </div>
