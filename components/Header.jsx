...
//                 <Link
//                   href="#"
//                   className="text-white hover:opacity-70 transition-all ease-in-out duration-200 font-semibold tracking-[-0.38px]  font-Montserrat sm:text-[3vw] text-[4vw] pt-9"
//                 >
//                   FAQ
//                 </Link>
//                 <Link
//                   href="#"
//                   className="text-white hover:opacity-70 transition-all ease-in-out duration-200 font-semibold tracking-[-0.38px]  font-Montserrat sm:text-[3vw] text-[4vw] py-9"
//                 >
//                   About Us
//                 </Link>
//                 <Link
//                   href="#"
//                   className="text-white hover:opacity-70 transition-all ease-in-out duration-200 font-semibold tracking-[-0.38px]  font-Montserrat sm:text-[3vw] text-[4vw]"
//                 >
//                   Pricing
//                 </Link>
//                 <span>
//                   <button className="text-white font-Montserrat text-3xl text-center font-bold border-[#50EED7] border-[2px] rounded-full bg-[#163A4F] py-4 mt-9 hover:bg-transparent transition-all w-[197px]">
//                     Dashboard
//                   </button>
//                 </span>
//               </div>
