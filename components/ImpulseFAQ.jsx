...
//               }
//               className="w-full  relative flex justify-between items-center text-white focus:outline-none font-Montserrat md:text-2xl sm:text-[17px] text-[15px] font-bold leading-[130%] mb-0 text-start"
//             >
//               {item.question}
