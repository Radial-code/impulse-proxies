  ...
  return (
    <div className="relative">
      <button
        ...
        className="text-white font-semibold flex items-center leading-[150%] font-Montserrat sm:text-[3vw] text-[4vw] lg:text-2xl mx-auto relative hover:opacity-70 transition-all ease-in-out duration-200"
      >
