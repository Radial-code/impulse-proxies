...
const DropDown = () => {
  ...
  return (
    <div className="flex justify-center lg:inline-block lg:justify-start ">
      ...
      {isOpen && (
        <ul className="absolute z-20 w-60 mt-10 lg:mt-2 py-2 bg-[#040426] rounded-lg shadow-lg border-white border ">
          {options.map((option) => (
            <li
              key={option}
...
//   // Define components for different options
//   const components = {
//     "ISP Proxies": () => <div>ISP Proxies Component</div>,
//     "Datacenter Proxies": () => <div>Datacenter Proxies Component</div>,
//     "Residential Proxies": () => <div>Residential Proxies Component</div>,
//   };
