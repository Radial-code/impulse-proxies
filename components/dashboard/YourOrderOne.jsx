...
const YourOrderOne = () => {
  ...
  return (
    <>
      <div className="bg-[#1E1E43] yourbox_border relative pb-[28px] sm:ps-6 px-4 pt-6 rounded-2xl lg:h-full custom_scrollbar_y max-h-[768px] max_height_box xl:max-h-[1020px] lg:max-h-[1035px] custom_your_order_box_style">
        ...
        <div className="flex flex-col justify-between h-full">
          <div className="flex justify-start mt-6 max-h-[150px] lg:max-h-[960px] sm:max-h-[613px] overflow-y-auto custom_scrollbar_y">
            <div
              id="textToCopy"
