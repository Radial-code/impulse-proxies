...
const RewardsDashboard = () => {
  ...
  return (
    <>
      <div className="relative lg:pb-[76px] sm:pb-12 pb-[66px]">
              ...
              {rewardData.length > 0 ? (
                <>
                  <div className="w-full lg:w-6/12 px-3">
                    ...
                    <div className="relative bg-[0px] h-[249px]  flex flex-col justify-center items-center mt-[-13px] rounded-b-[16px]  earned_rewards_box">
